...
/**
 * Offset/Address/Size: 0x1FC | 0x801D123C | size: 0xA8
 */
...
/**
 * Offset/Address/Size: 0x2A4 | 0x801D12E4 | size: 0xC
 */
...
/**
 * Offset/Address/Size: 0x2B0 | 0x801D12F0 | size: 0x154
 */
u32 nlChecksum32(const void* data, unsigned long len)
{
    s32 temp_r12;
    s32 var_ctr_2;
    u32 temp_r10_2;
    ...
    if (len > 0U)
    {
        ...
        if (len > 8U)
        {
            if (temp_r7 > 0U)
            {
                for (int i = (temp_r7 + 7) >> 3U; i != 0; i--, var_r3 += 8)
                {
                    var_r6 += 8;
                    temp_r11 = var_r3[2];
                    temp_r10 = var_r3[3];
                    temp_r9 = var_r3[4];
                    temp_r31 = (var_r9 >> 8U) ^ crcTable[(u8)(var_r9 ^ var_r3[0])];
                    temp_r8 = var_r3[5];
                    temp_r7_2 = var_r3[6];
                    temp_r0 = var_r3[7];
                    temp_r12 = crcTable[(u8)(temp_r31 ^ var_r3[1])];
                    temp_r31_2 = temp_r31 >> 8U;
                    temp_r12_2 = temp_r31_2 ^ temp_r12;

                    temp_r11_2 = (temp_r12_2 >> 8U) ^ crcTable[(u8)(temp_r12_2 ^ temp_r11)];
                    temp_r10_2 = (temp_r11_2 >> 8U) ^ crcTable[(u8)(temp_r11_2 ^ temp_r10)];
                    temp_r9_2 = (temp_r10_2 >> 8U) ^ crcTable[(u8)(temp_r10_2 ^ temp_r9)];
                    temp_r8_2 = (temp_r9_2 >> 8U) ^ crcTable[(u8)(temp_r9_2 ^ temp_r8)];
                    temp_r7_3 = (temp_r8_2 >> 8U) ^ crcTable[(u8)(temp_r8_2 ^ temp_r7_2)];
                    var_r9 = (temp_r7_3 >> 8U) ^ crcTable[(u8)(temp_r7_3 ^ temp_r0)];
                }
            }
        }
        var_ctr_2 = len - var_r6;
        if (var_r6 < len)
        {
            do
            {
                temp_r0_2 = *var_r3;
                var_r3 += 1;
                var_r9 = (var_r9 >> 8U) ^ crcTable[(u8)(var_r9 ^ temp_r0_2)];
                var_ctr_2 -= 1;
            } while (var_ctr_2 != 0);
        }
    }
    return ~(var_r9 | var_r9);
}

/**
 * Offset/Address/Size: 0x404 | 0x801D1444 | size: 0x30
 */
void nlInit()
{
    nlInitMemory();
