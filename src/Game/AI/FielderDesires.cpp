 ...
 */
void CommonDesireData::CalcFuzzyChance(float)
{
}
 ...
 */
void CommonDesireData::CalcBoolChance(float)
{
}
 ...
 */
void CommonDesireData::NormalizeConfidence(float)
{
}
 ...
 */
void GetCommonDesireData(eFielderDesireState)
{
}
