 ...
 */
void PhysicsBanana::SetContactInfo(dContact*, PhysicsObject*, bool)
{
}
 ...
 */
void PhysicsBanana::Contact(PhysicsObject*, dContact*, int)
{
}
 ...
 */
PhysicsBanana::PhysicsBanana(float)
{
}

/**
 * Offset/Address/Size: 0x0 | 0x80136208 | size: 0x8
 */
void PhysicsBanana::GetObjectType() const
{
}

/**
 * Offset/Address/Size: 0x0 | 0x80136210 | size: 0x8
 */
void CollisionPowerupGroundData::GetID()
{
}
