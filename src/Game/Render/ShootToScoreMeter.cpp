 ...
 */
void ShootToScoreMeter::TurnOnMeter(ShootToScoreMeter::STSMeterType, float)
{
}
 ...
 */
void ShootToScoreMeter::RumbleMeter(float, float, float)
{
}
 ...
 */
void ShootToScoreMeter::SetWhiteBarPosition(float)
{
}
 ...
 */
void ShootToScoreMeter::SetSavedWhiteBarPosition(float)
{
}
 ...
 */
void ShootToScoreMeter::SetGreenBarPosition(float)
{
}
 ...
 */
void ShootToScoreMeter::SetGreenRegionWidth(float)
{
}
