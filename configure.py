...
config.libs = [
    ...
    GameLib(
        ...
        [
            ...
            Object(NonMatching, "Game/SH/SHPauseOptions.cpp", extra_cflags=["-inline deferred"]),
            ...
            Object(NonMatching, "Game/SH/SHQuickGameplayOptions.cpp", extra_cflags=["-inline deferred"]),
