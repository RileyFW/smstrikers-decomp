...
config.libs = [
    ...
    GameLib(
        ...
        [
            ...
            # Game/Transitions
            Object(NonMatching, "Game/Transitions/ColourBlendScreenTransition.cpp", extra_cflags=["-inline deferred"]),
            ...
            Object(NonMatching, "Game/Render/Wiper.cpp", extra_cflags=["-inline deferred"]),
